...
{{- define "unifi.tlsCert" -}}
{{- if and .Values.auth.tls.enabled .Values.auth.tls.autoGenerated }}
    {{- printf "cert.pem" -}}
{{- else -}}
    {{- printf "%s" .Values.auth.tls.certFilename -}}
{{- end -}}
{{- end -}}

{{/* Return the path to the cert key file. */}}
{{- define "unifi.tlsCertKey" -}}
{{- if and .Values.auth.tls.enabled .Values.auth.tls.autoGenerated }}
    {{- printf "privkey.pem" -}}
{{- else -}}
    {{- printf "%s" .Values.auth.tls.certKeyFilename -}}
{{- end -}}
{{- end -}}

{{/* Return the path to the CA cert file. */}}
{{- define "unifi.tlsCACert" -}}
{{- if and .Values.auth.tls.enabled .Values.auth.tls.autoGenerated }}
    {{- printf "chain.pem" -}}
{{- else -}}
    {{- printf "%s" .Values.auth.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
...
{{/* Validate values of UniFi - Auth TLS enabled */}}
{{- define "unifi.validateValues.auth.tls" -}}
{{- if and .Values.auth.tls.enabled (not .Values.auth.tls.autoGenerated) (not .Values.auth.tls.existingSecret) }}
unifi: auth.tls.enabled
    In order to enable TLS, you also need to provide an existing secret containing the Keystore and Truststore or
