...
| `crds.enabled`                                        | Bundle the `open-appsec-crd` subchart with this release. Disable to manage CRDs via a separately-installed `open-appsec-crd` chart (recommended for production, where the schema lifecycle is typically decoupled from the application lifecycle).                                                                                                                  | `false`   |
...
| Name                            | Description                  | Value          |
| ------------------------------- | ---------------------------- | -------------- |
| `defaultConfigurations.enabled` | Enable defaultConfigurations | `false`        |
| `defaultConfigurations.mode`    |                              | `detect-learn` |
