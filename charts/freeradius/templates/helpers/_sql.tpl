...
`/opt/startechnica/freeradius/certs-sql` (see Deployment.yaml `freeradius-sql-tls`
volumeMount).
*/}}
{{- define "freeradius.sql.tls.certPath" -}}
{{- if .Values.modules.sql.tls.enabled -}}
  {{- if .Values.modules.sql.tls.certFilename -}}
    {{- printf "/opt/startechnica/freeradius/certs-sql/%s" .Values.modules.sql.tls.certFilename -}}
  {{- else -}}
...
{{- if .Values.modules.sql.tls.enabled -}}
  {{- if .Values.modules.sql.tls.certKeyFilename -}}
    {{- printf "/opt/startechnica/freeradius/certs-sql/%s" .Values.modules.sql.tls.certKeyFilename -}}
  {{- else -}}
...
{{- if .Values.modules.sql.tls.enabled -}}
  {{- if .Values.modules.sql.tls.certCAFilename -}}
    {{- printf "/opt/startechnica/freeradius/certs-sql/%s" .Values.modules.sql.tls.certCAFilename -}}
  {{- else -}}
...
{{- if and .Values.modules.sql.tls.enabled (not .Values.modules.sql.tls.certificatesSecret) (not .Values.modules.sql.tls.existingTlsSecret) -}}
true
{{- end -}}
{{- end -}}
