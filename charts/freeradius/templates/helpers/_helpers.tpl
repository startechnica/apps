...
{{- if .Values.modules.eap.enabled -}}
  {{- if .Values.modules.eap.tlsConfig.certFilename -}}
    {{- printf "/opt/startechnica/freeradius/certs-eap/%s" .Values.modules.eap.tlsConfig.certFilename -}}
  {{- else -}}
...
{{- if .Values.modules.eap.enabled -}}
  {{- if .Values.modules.eap.tlsConfig.certKeyFilename -}}
    {{- printf "/opt/startechnica/freeradius/certs-eap/%s" .Values.modules.eap.tlsConfig.certKeyFilename -}}
  {{- else -}}
...
{{- if .Values.modules.eap.enabled -}}
  {{- if .Values.modules.eap.tlsConfig.certCAFilename -}}
    {{- printf "/opt/startechnica/freeradius/certs-eap/%s" .Values.modules.eap.tlsConfig.certCAFilename -}}
  {{- else -}}
...
{{- if .Values.modules.eap.tlsConfig.certificatesSecret -}}
{{- .Values.modules.eap.tlsConfig.certificatesSecret -}}
{{- else -}}
...
{{- if and .Values.modules.eap.enabled .Values.modules.eap.tlsConfig.autoGenerated (not .Values.modules.eap.tlsConfig.certificatesSecret) -}}
true
{{- end -}}
{{- end -}}
