...
Usage:
{{ include "st-common.warnings.rollingTag" .Values.path.to.the.imageRoot }}
*/}}
{{- define "st-common.warnings.rollingTag" -}}
...
Usage:
{{ include "st-common.warnings.modifiedImages" (dict "images" (list .Values.path.to.the.imageRoot) "context" $) }}
*/}}
{{- define "st-common.warnings.modifiedImages" -}}
{{- $affectedImages := list -}}
{{- $printMessage := false -}}
...
Usage:
{{ include "st-common.warnings.resources" (dict "sections" (list "path1" "path2") context $) }}
Example:
{{- include "st-common.warnings.resources" (dict "sections" (list "csiProvider.provider" "server" "volumePermissions" "") "context" $) }}
The list in the example assumes that the following values exist:
  ...
  - resources
*/}}
{{- define "st-common.warnings.resources" -}}
